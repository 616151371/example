package com.heeexy.example.util.system;
 ...
 * @throws IOException 
    ...
    public static void backup(String pathname) throws Exception {
            ...
            // 调用 mysql 的 cmd:
            Process child = rt.exec("mysqldump -root -root --set-charset=utf-8 mystock");// 设置导出编码为utf8。这里必须是utf8
    ...
    public static void load(String pathname) throws Exception {
            Runtime rt = Runtime.getRuntime();
            // 调用 mysql 的 cmd:
            Process child = rt.exec("mysql -root -root mystock");
